...
final class SingleProductMarkupTest extends TestCase
{
    public function testThemeWrapperAcrossPriceAndActionBlocksRemainsBalanced(): void
    {
        ...
        $action = str_replace(['sw_extends', 'sw_include'], ['extends', 'include'], file_get_contents($root . 'product/card/action.html.twig'));
        $purchase = str_replace('sw_extends', 'extends', file_get_contents($root . 'uct-single-product/action.html.twig'));
        $twig = new Environment(new ArrayLoader([
            'card' => $card,
            'action' => $action,
            '@UltimateCmsTools/storefront/component/uct-single-product/action.html.twig' => $purchase,
