...
export default class ManufacturerCarouselPlugin extends Plugin {
    static options = {
        arrows: true,
        dots: true,
        autoplay: true,
    ...
    init() {
        try {
            this.container = DomAccess.querySelector(this.el, '.manufacturer-carousel-container');
            this.prevBtn = this.options.arrows ? DomAccess.querySelector(this.el, '.manufacturer-carousel-control.prev', false) : null;
            this.nextBtn = this.options.arrows ? DomAccess.querySelector(this.el, '.manufacturer-carousel-control.next', false) : null;
            this.dots = this.options.dots ? DomAccess.querySelectorAll(this.el, '.manufacturer-carousel-dot', false) : [];
            this.cards = DomAccess.querySelectorAll(this.container, '.manufacturer-card', false);
        } catch (e) {
            return;
        }
